...
results_csv_path = "../results/dmv_results.csv"
trained_model_path = "../models/train_dmv_ppo/trial_2/best_model"
params_path = "../models/train_dmv_ppo/trial_2/params.txt"
max_request_size = 1
environment_generator_f = ev.dmv_sim_env
rl_single_price_control_board_generator_f = sf.RLSinglePriceBoxActionTranslator
baseline_agent_builder_f = ag.build_dmv_no_premium_agent
rule_agent_builder_f = ag.build_dmv_rule_agent
min_price = 2
