...
results_csv_path = "../results/restaurant_results.csv"
trained_model_path = "../models/train_restaurant_ppo/trial_3/best_model"
params_path = "../models/train_restaurant_ppo/trial_3/params.txt"
max_request_size = 10
environment_generator_f = ev.restaurant_sim_env
rl_single_price_control_board_generator_f = sf.RLSinglePriceBoxActionTranslator
baseline_agent_builder_f = ag.build_restaurant_no_premium_agent
rule_agent_builder_f = ag.build_restaurant_rule_agent
min_price = 2
